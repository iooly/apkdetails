...
/**
 * This class seemlesly extends exisiting serialzier implementation by adding
 * new methods (provided by XmlPullUtil) and delegating exisiting methods to
 ...
 */
public class StaticXmlSerializerWrapper extends XmlSerializerDelegate implements
    ...
    public XmlSerializerWrapper startTag(String name) throws IOException,
            IllegalArgumentException, IllegalStateException {
        xs.startTag(currentNs, name);
        return this;
    }

    public XmlSerializerWrapper endTag(String name) throws IOException,
            IllegalArgumentException, IllegalStateException {
    ...
    public XmlSerializerWrapper element(String namespace, String elementName,
            String elementText) throws IOException, XmlPullParserException {
    ...
    private void ensureNamespacesCapacity() {
        ...
        if (namespacePrefix != null) {
            ...
            System.arraycopy(namespaceDepth, 0, newNamespaceDepth, 0,
                    namespaceEnd);
        }
    ...
    public void fragment(String xmlFragment) throws IOException,
            IllegalArgumentException, IllegalStateException,
            XmlPullParserException {
        StringBuffer buf = new StringBuffer(xmlFragment.length() + namespaceEnd
                * 30);
        buf.append("<fragment");
    ...
    public void event(XmlPullParser pp) throws XmlPullParserException,
            IOException {
    ...
    private void writeStartTag(XmlPullParser pp) throws XmlPullParserException,
            IOException {
        ...
        for (int i = 0; i < pp.getAttributeCount(); i++) {
            ...
            String ans = pp.getAttributeNamespace(i);
    ...
    public void writeDouble(double d) throws XmlPullParserException,
    ...
    public void writeFloat(float f) throws XmlPullParserException, IOException,
    ...
    public void writeInt(int i) throws XmlPullParserException, IOException,
            IllegalArgumentException {
        xs.text(Integer.toString(i));
    }

    public void writeString(String s) throws XmlPullParserException,
            IOException, IllegalArgumentException {
        if (s == null) {
