...
public class ApkDecoder {
    ...
    private boolean mIsDecodeSrc = true;
    ...
    public void setDecodeSrc(boolean isDecodeSrc) {
        mIsDecodeSrc = isDecodeSrc;
    }
    ...
    public void decode() throws AndrolibException {
        ...
        if (hasResources()) {
            ...
            case DECODE_RESOURCES_FULL:
                ...
                break;
            case DECODE_RESOURCES_MAINXML:
                mAndrolib.decodeResourcesMainXml(mApkFile, outDir,
                        getResTable());
            }
        }
        if (mDecodeResources != DECODE_RESOURCES_MAINXML) {
    ...
    public final static short DECODE_RESOURCES_MAINXML = 0x0110;
    ...
    // private short mDecodeSources = DECODE_SOURCES_JAVA;
