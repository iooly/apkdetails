...
public class SmaliMod {
    ...
    public static boolean assembleSmaliFile(InputStream smaliStream, String name, DexFile dexFile,
            boolean verboseErrors, boolean oldLexer, boolean printTokens) throws IOException,
        ...
        if (printTokens) {
            ...
            for (int i = 0; i < tokens.size(); i++) {
                ...
                System.out
                        .println(smaliParser.tokenNames[token.getType()] + ": " + token.getText());
            }
        }
