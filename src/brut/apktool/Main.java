...
public class Main {
    ...
    public final static void main(String[] args) throws IOException,
            AndrolibException, InterruptedException, DirectoryException {
        try {
            ...
            } else if ("dres".equals(cmd)) {
                cmdDecode(args, true, false);
            } else if ("mainxml".equals(cmd)) {
                cmdDecode(args, true, true);
            } else {
                throw new InvalidArgsError();
            }
    ...
    private static void cmdDecode(String[] args, boolean onlyRes,
            boolean onlyMainXml) throws InvalidArgsError, AndrolibException {
        ...
        if (onlyRes) {
            decoder.setDecodeSrc(false);
        }

        if (onlyMainXml) {
            decoder.setDecodeSrc(false);
            decoder.setDecodeResources(ApkDecoder.DECODE_RESOURCES_MAINXML);
        }
    ...
    static class InvalidArgsError extends AndrolibException {
        ...
        private static final long serialVersionUID = 1985064503892190385L;
