...
public class DirUtil {
    ...
    public static void copyToFile(Directory in, Directory out, String inFileName, String outFileName)
            throws DirectoryException {
        try {

            BrutIO.copyAndClose(in.getFileInput(inFileName),
                    out.getFileOutput(outFileName));

        } catch (IOException ex) {
            throw new DirectoryException(
                    "Error copying file: " + inFileName + " to " + outFileName, ex);
        }
    }

    public static void copyToFile(Directory in, File out, String inFileName, String outFileName)
            throws DirectoryException {
        try {
