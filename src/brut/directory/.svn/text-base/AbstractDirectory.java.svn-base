...
public abstract class AbstractDirectory implements Directory {
    ...
    @Override
    public void copyToFile(Directory out, String inFileName, String outFileName)
            throws DirectoryException {
        DirUtil.copyToFile(this, out, inFileName, outFileName);
    }

    @Override
    public void copyToFile(File out, String inFilename, String outFileName)
            throws DirectoryException {
        DirUtil.copyToFile(this, out, inFilename, outFileName);
    }
